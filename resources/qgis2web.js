...
map.getView().fit([8734289.797418, 734534.287896, 9169018.145546, 1077564.920934], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Environmental Aspect</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (20 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Puttalam and Mannar ';
            }
